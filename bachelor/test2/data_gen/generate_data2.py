...
num_failure = config["train"]["num_failure"]
...
djk_traffic_log, data_log, links_log, target_log, traffic_log = [], [], [], [], []
...
while len(target_log) < num_data:
    ...
    djk_traffic_list, data_list, links_list, target_list, traffic_list = [], [], [], [], []
