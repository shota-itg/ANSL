...
#########################################################################################################################
            ...
            # initial_load_dict = build_initial_load_dict_from_modality2(data, i, capacity_dict) # リンク数用

            current_load_dict = {key: 0.0 for key in capacity_dict}
#########################################################################################################################
            ...
            demands = []
            for j in range(NP_2):
                src, dst, bw = parse_demand(data, i, j, N, NP_2)
            ...
            if all_checker:
                for key in current_load_dict:
                    ...
                    links_list += [current_load_dict[key]]
